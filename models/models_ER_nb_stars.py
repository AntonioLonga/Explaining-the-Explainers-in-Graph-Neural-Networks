...
class GCN_framework:
    def __init__(self,dataset,device=None):   
        ...
        self.optimizer = torch.optim.Adam(self.model.parameters(),lr=0.005) #0.0001
    ...
    def __init__(self,dataset,device=None):   
        ...
        class Net(torch.nn.Module):
            def __init__(self,num_features,num_classes):
                ...
                self.conv3 = SAGEConv(30, 30,normalize=True,project=True)
...
#                print(s.shape, x.shape, "re")
        ...
        self.model = Net(3, self.dataset.num_classes, self.max_nodes).to(self.device)
        self.optimizer = torch.optim.Adam(self.model.parameters(),lr=0.001) #0.0001
